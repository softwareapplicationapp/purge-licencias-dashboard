...
// Log all requests
error_log("addlicenses_simple.php called with method: " . $_SERVER['REQUEST_METHOD']);
...
error_log("Decoded serials: " . print_r($serials, true));
...
try {
    ...
    foreach ($serials as $serialData) {
        ...
        if ($licenseType === 'LIFETIME_PRO') {
            ...
            error_log("Inserting into apipro table");
            ...
            error_log("Inserting into apipremium table");
        ...
        error_log("Successfully inserted license: " . $serial);
    }
